...
import 'package:mathgame/src/ui/dashboard/enter_name_view.dart';
import 'package:mathgame/src/ui/dashboard/leaderboard_view.dart';
import 'package:tuple/tuple.dart';

var appRoutes = {
  KeyUtil.dashboard: (context) => DashboardView(),
  KeyUtil.splash: (context) => SplashView(),
  KeyUtil.enterName: (context) => const EnterNameView(),
  KeyUtil.leaderboard: (context) => const LeaderboardView(),
