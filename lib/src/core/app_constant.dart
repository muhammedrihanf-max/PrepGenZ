...
class KeyUtil {
  ...
  static List<Dashboard> dashboardItems = [
    Dashboard(
      ...
      colorTuple: Tuple2(Color(0xffFF6B6B), Color(0xffEE5A24)),
      opacity: 0.07,
      ...
      title: "Math GenZ",
      fillIconColor: Color(0xffFF6B6B),
      outlineIconColor: Color(0xffEE5A24),
    ),
    Dashboard(
      puzzleType: PuzzleType.MEMORY_PUZZLE,
      colorTuple: Tuple2(Color(0xffF0932B), Color(0xffD35400)),
      opacity: 0.07,
      ...
      title: "Memory Puzzle",
      fillIconColor: Color(0xffF0932B),
      outlineIconColor: Color(0xffD35400),
    ),
    Dashboard(
      puzzleType: PuzzleType.BRAIN_PUZZLE,
      colorTuple: Tuple2(Color(0xffE84393), Color(0xffC0392B)),
      opacity: 0.12,
      ...
      fillIconColor: Color(0xffE84393),
      outlineIconColor: Color(0xffC0392B),
    ),
  ];
